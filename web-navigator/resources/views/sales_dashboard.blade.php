    ...
    <div class="subheader py-2 py-lg-12 subheader-transparent" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap p-0">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="{{route('sales-add-domain')}}" class="btn bg-blue text-white font-weight-bold ml-2"><i class="fa fa-spider mr-1 text-white" aria-hidden="true"></i>Add Domain</a>
            </div>
        </div>
    </div>
    <div class="card mb-5">
                ...
                <table class="table table-hover" id="domain_table">
                    <thead class="bg-blue text-white">
                        <tr>
                            ...
                            <th scope="col" class="text-center">Total Sample URLs</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var table = $('#domain_table').DataTable({
            ...
            order: [],
            ajax : {
                url : "/navibot/web-navigator/sales/dashboard",
                data: function(d){
    ...
    //
    function deleteSalesDomains(id){
        swal({
            ...
            if (e.value) {
                $.ajax({
                    type: 'GET',
                    url  : "/navibot/web-navigator/sales/sales-domain-delete/"+id,
                }).done(function(data) {
